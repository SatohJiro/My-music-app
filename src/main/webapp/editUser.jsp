	...
	<nav
		...
		<div
			...
			<a
				...
				href="index.jsp"> Mp3 Management </a>
			...
			<div navbar-menu=""
				...
				<ul
					...
					<li><a
						...
						href="users.jsp"> <i class="mr-1 fa fa-user opacity-60"
					...
					<li><a
						class="block px-4 py-2 mr-2 font-normal transition-all lg-max:opacity-0 duration-250 ease-soft-in-out text-size-sm text-slate-700 lg:px-2"
						href="profile.jsp"> <i class="mr-1 fas fa-key opacity-60"
					...
					<div
						...
						<div class="flex-auto p-6">
							<form role="form" method="post"
								action="./EditUserServlet?userName=${user.getNameUser()}">
								<label class="mb-2 ml-1 font-bold text-size-xs text-slate-700">Name</label>
								<div class="mb-4">
									<input type="text"
										...
										placeholder="${user.getName()}" name="newName" />
								</div>
								...
								<div class="mb-4">
									<input type="email"
										...
										placeholder="${user.getEmail()}" name="newEmail" />
								</div>

								<label class="mb-2 ml-1 font-bold text-size-xs text-slate-700">Phone
									number</label>
								<div class="mb-4">
								...
								<label class="mb-2 ml-1 font-bold text-size-xs text-slate-700">Location</label>
								<div class="mb-4">
									<input type="text" placeholder="${user.getAddress()}"
										name="newAddress"
										class="focus:shadow-soft-primary-outline text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" />
								</div>
								<div class="flex items-center justify-between">
									<div class="">
										<label class="mb-2 ml-1 font-bold text-size-xs text-slate-700">Is
											admin?</label>
										<div class="mb-4 flex items-center gap-4">
											<div class="flex items-center gap-2">
												<input type="radio" value="1" name="role" /> <label for="1">Yes</label>
											</div>
											<div class="flex items-center gap-2">
												<input type="radio" value="0" name="role" /> <label for="0">No</label>
											</div>
										</div>
									</div>
									<div class="">
										<label class="mb-2 ml-1 font-bold text-size-xs text-slate-700">Gender</label>
										<div class="mb-4 flex items-center gap-4">
											<div class="flex items-center gap-2">
