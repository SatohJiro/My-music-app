...
<body
	...
	<c:set var="Song" value="${requestScope.song}"></c:set>
				...
				<div
					...
					<div
						...
						<div class="flex-auto p-6">
							<form role="form" method="post" action="./EditSongServlet"
								...
								<input type="hidden"
									...
									value="${Song.getIdSong()}" name="idSong" /> <label
									class="mb-2 ml-1 font-bold text-size-xs text-slate-700">Song
									name</label>
								<div class="mb-4">
									<input type="text"
										class="focus:shadow-soft-primary-outline text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
										placeholder="${Song.getNameSong()}" name="songName" />
								</div>
								...
								<div class="mb-4">
									<input list="artist-list"
										...
										placeholder="${Song.getNameArtist()}" name="songArtist" />
								...
								<div class="mb-4">
									<input list="category-list"
										class="focus:shadow-soft-primary-outline text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
										placeholder="${Song.getMainCategory()}" name="songTopic" />
