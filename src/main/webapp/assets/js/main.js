...
// logout
const logOption = $(".app__header-options.options--logout");

const logOutBtn = $(".option__log-out");
const managementBtn = $(".option__management");

/*const logInBtn = $(".option__log-in");*/
// setting
...
const app = {
	...
	handleEvents: function() {
		...
		document.onclick = (e) => {
			...
			if (managementBtn) {
				managementBtn.classList.remove("open");
			}
		...
		if (logOption) {
			logOption.onclick = (e) => {
				...
				if(managementBtn){
					managementBtn.classList.toggle("open");
				}
